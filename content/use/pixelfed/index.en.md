...
An open source federated alternative to Instagram, PixelFed is a photo-oriented social network with filters, comments, likes, shares etc. but no ads and no tracking. You can see an [example of a PixelFed account here](https://pixelfed.social/earth), and an [example post here](https://pixelfed.social/p/earth/22346]).
...
Also, because PixelFed sites connect together using the ActivityPub standard, you can follow millions of people on other ActivityPub sites like [Mastodon](/use/mastodon), and they can follow you too.
